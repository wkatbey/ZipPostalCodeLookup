...
var zip_code_lookup_response_1 = require("../../models/zip-code-lookup-response");
        ...
        return function (formGroup) {
            ...
            if (addressFirstLine && city && state) {
                return zipcodeLookupService.getZipcodeByAddress(address).pipe(operators_1.map(function (response) {
                    var zipcode = new zip_code_lookup_response_1.ZipCodeLookupResponse(response).zipcode;
